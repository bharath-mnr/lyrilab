...
const earTrainingQuizTool = {
    id: 'ear-training-quiz',
    name: 'Ear Training Quiz',
    description: 'Comprehensive ear training exercises for intervals, chords, scales, and rhythm recognition.',
...
const EarTrainingQuizContent = () => {
    ...
    return (
        <>
            ...
            <SEOHead 
                pageId="ear-training-quiz" 
                tool={earTrainingQuizTool}
                customData={{}}
            />
