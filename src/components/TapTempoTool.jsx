...
const tapTempoTool = {
    id: 'tap-tempo-tool',
    name: 'Tap Tempo',
    description: 'Tap along to music to calculate its BPM (beats per minute) with our accurate tap tempo detection tool.',
    path: '/tap-tempo-tool',
    categories: [
        'Tempo Detection',
        'Music Practice',
...
const TapTempoTool = () => {
  ...
  return (
    <>
        <SEOHead
          pageId="tap-tempo-tool"
          Tool = {tapTempoTool}
          structuredData={tapTempoTool}
        />
      <div
